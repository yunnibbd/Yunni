...
namespace Yunni {
	...
	static void GLFWErrorCallback(int error, const char* descrption)
	{
		YN_CORE_ERROR("GLFW Error ({0}): {1}", error, descrption);
	}
	...
	void WindowsWindow::Init(const WindowProps& props)
	{
		...
		YN_CORE_INFO("Creating window {0} ({1}, {2})", props.Title, props.Width, props.Height);
